...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card border-0 shadow-none mb-0">
                        <div class="card-body rounded profile-basic"
                            style="background-image: url('../assets/images/small/img-4.jpg');background-size: cover;">
                        </div>
                        <div class="card-body">
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    <img src="{{ URL::asset('assets/images/small/img-4.jpg') }}" alt="" class="w-100 rounded object-fit-cover"
                        height="120">
