                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('assets/images/modals/login.png') }}" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div><!-- end card body -->
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('assets/images/modals/signup.png') }}" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div><!-- end card body -->
