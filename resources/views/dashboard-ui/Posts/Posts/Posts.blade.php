...
@endsection
@section('content')
    <x-breadcrumb title="Manage Posts" pagetitle="Posts" />
		@if (session('success'))
		<div class="row">
			<div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
															<div>
																<textarea class="form-control" id="PostEnExcerpt" name="en_excerpt" placeholder="Post Excerpt"></textarea>
															</div>
															@error("en_excerpt")
															<span class="text-danger">{{$message}}</span>
															@enderror
                            ...
                            <div class="col-lg-6">
															<div>
																<textarea class="form-control ckeditor-classic" id="PostEnContent" name="en_content" placeholder="Post Content"></textarea>
															</div>
															@error("en_content")
															<span class="text-danger">{{$message}}</span>
															@enderror
                            ...
                            <div class="col-lg-6">
															<div>
																<input type="text" class="form-control" id="PostTags" name="post_tags" placeholder="Post Tags">
															</div>
															@error("post_tags")
															<span class="text-danger">{{$message}}</span>
															@enderror
					...
					<table class="table table-nowrap">
						...
						<tbody>
								...
								<tr id="Post{{$Post->id}}Row">
										...
										<td>
											<a href="{{route("EditPost", $Post->id)}}" class="link-success">Edit <i class="ri-arrow-right-line align-middle"></i></a> /&nbsp;
											<a href="#" class="link-danger" onClick="addLocation('{{route("DeletePost", $Post->id)}}')" data-bs-toggle="modal" data-bs-target="#deleteRecordModal">Delete <i class="ri-delete-bin-6-line align-middle"></i></a>
										</td>
								</tr>
										...
										<td colspan="3">
											<table class="table table-nowrap" style="margin-left: 20px;">
												<tr id="Child{{$Child->id}}Row">
													...
													<td>
														<a href="{{route("EditPost", $Child->id)}}" class="link-success">Edit <i class="ri-arrow-right-line align-middle"></i></a> /&nbsp;
														<a href="#" class="link-danger" onClick="addLocation('{{route("DeletePost", $Child->id)}}')" data-bs-toggle="modal" data-bs-target="#deleteRecordModal">Delete <i class="ri-delete-bin-6-line align-middle"></i></a>
													</td>
												</tr>		
											</table>
										</td>
