        ...
        <div class="col-md-8">
					<table class="table table-nowrap">
						...
						<tbody>
								...
								<tr id="Role{{$role->id}}Row">
										<th scope="row"><a href="#" class="fw-semibold">{{$role->id}}</a></th>
										<td>{{$role->name}}</td>
										<td>
											<a href="{{route("EditRole", $role->id)}}" class="link-success">Edit <i class="ri-arrow-right-line align-middle"></i></a> /&nbsp;
											<a href="#" class="link-danger" onClick="addLocation('{{route("DeleteRole", $role->id)}}')" data-bs-toggle="modal" data-bs-target="#deleteRecordModal">Delete <i class="ri-delete-bin-6-line align-middle"></i></a>
										</td>
								</tr>
								@endforeach
						</tbody>
