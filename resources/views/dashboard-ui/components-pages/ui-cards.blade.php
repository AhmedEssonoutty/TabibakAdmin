    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('assets/images/small/img-10.jpg') }}" alt="Card image">
            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="{{ URL::asset('assets/images/small/img-9.jpg') }}" alt="Card image cap">
                        <div class="card-header">
                            <h4 class="card-title mb-0">A day in the of a professional fashion designer</h4>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="{{ URL::asset('assets/images/small/img-8.jpg') }}" alt="Card image cap">
                    </div>
                </div><!-- end col -->
            </div>
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover"
                                    src="{{ URL::asset('assets/images/small/img-7.jpg') }}" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-header">
    ...
    <div class="row g-3">
        ...
        <div class="col-xxl col-md-4">
            <div class="card h-100">
                ...
                <img class="img-fluid" src="{{ URL::asset('assets/images/small/img-6.jpg') }}" alt="Card image cap" />
                <div class="card-body">
