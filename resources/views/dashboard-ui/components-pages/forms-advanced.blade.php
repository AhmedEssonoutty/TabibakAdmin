...
@section('css')
    <!-- add extra css -->
    <!-- multi.js css -->
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/libs/multi.js/multi.min.css') }}" />
    <!-- autocomplete css -->
    <link rel="stylesheet" href="{{ URL::asset('assets/libs/@tarekraafat/autocomplete.js/autoComplete.css') }}">
@endsection
@section('content')
    <!-- page title -->
                            ...
                            <div>
                                ...
                                <div class="input-group" data-input-flag>
                                    <button class="btn btn-light border" type="button" data-bs-toggle="dropdown"
                                        aria-expanded="false"><img src="{{ URL::asset('assets/images/flags/us.svg') }}" alt="flag img"
