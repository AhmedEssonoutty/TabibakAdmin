...
@section('css')
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/libs/@simonwep/classic.min.css') }}" /> <!-- 'classic' theme -->
    <link rel="stylesheet" href="{{ URL::asset('assets/libs/@simonwep/monolith.min.css') }}" /> <!-- 'monolith' theme -->
    <link rel="stylesheet" href="{{ URL::asset('assets/libs/@simonwep/nano.min.css') }}" /> <!-- 'nano' theme -->
@endsection
@section('content')
    <!-- page title -->
...
@section('scripts')
    ...
    <script src="{{ URL::asset('assets/libs/@simonwep/pickr.min.js') }}"></script>
