...
@endsection
@section('content')
    <x-breadcrumb title="Edit Roles" pagetitle="Accounts" />
		@if (session('success'))
		<div class="row">
			<div class="col-md-12">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="RoleName" name="name" value="{{$role->name}}" placeholder="Role Name">
                                </div>
																@error("name")
                            ...
                            @foreach (config("global.permissions") as $name => $value)
															<div class="col-lg-4">
																	...
																	<div class="form-check form-switch form-check-inline" dir="ltr">
																			<input type="checkbox" name="permissions[]" class="form-check-input" value="{{$name}}" {{in_array($name, $role->permissions)?"checked":""}} id="Per{{$name}}">
