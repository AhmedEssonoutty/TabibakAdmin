					...
					<table class="table table-nowrap">
						...
						<tbody>
								...
								<tr id="Category{{$Category->id}}Row">
										...
										<td>{{$Category->category_en_name}} - {{$Category->category_ar_name}} ({{$Category->post_type}})</td>
										<td>
											<a href="{{route("EditCategory", $Category->id)}}" class="link-success">Edit <i class="ri-arrow-right-line align-middle"></i></a> /&nbsp;
