...
@endsection
@section('content')
    <x-breadcrumb title="Edit Page" pagetitle="Pages" />
		@if (session('success'))
		<div class="row">
			<div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-lg-6">
															<div>
																<input type="text" class="form-control" id="EnTitle" name="en_title" value="{{$Post->en_title}}" placeholder="Page Title">
															</div>
															@error("en_title")
                            ...
                            <div class="col-lg-6">
															<div>
																<textarea class="form-control" id="EnExcerpt" name="en_excerpt" placeholder="Page Excerpt">{{$Post->en_excerpt}}</textarea>
															</div>
															@error("en_excerpt")
															<span class="text-danger">{{$message}}</span>
															@enderror
                            ...
                            <div class="col-lg-6">
															<div>
																<textarea class="form-control ckeditor-classic" id="EnContent" name="en_content" placeholder="Page Content">{{$Post->en_content}}</textarea>
															</div>
															@error("en_content")
															<span class="text-danger">{{$message}}</span>
															@enderror
                            ...
                            <div class="col-lg-6">
															<div>
																<select class="form-control" id="ParentPage" data-choices data-choices-removeItem name="post_parent" placeholder="Parent Page">
																...
																<div class="card-header">
																		<div class="d-flex">
																				...
																				<div class="flex-grow-1">
																						<h5 class="card-title mb-1">Page Image</h5>
																...
																<div class="card-body">
																		<div class="dropzone my-dropzone">
																				<div class="dz-message">
																						...
																						<h5>
																							Drop files here or click to upload if you want to change page image.
																							<br>
																							Otherwise leave it empty.
																						</h5>
																				</div>
																		</div>
																		<div class="error-msg mt-1">Please add a page images.</div>
																		@error("bg_image")
																		<span class="text-danger">{{$message}}</span>
																		@enderror
																	</div>
