    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="{{route('index')}}" class="nav-link menu-link"> <i class="bi bi-speedometer2"></i> <span data-key="t-dashboard">{{ __('t-dashboard') }}</span> <span class="badge badge-pill badge-soft-danger" data-key="t-hot">{{ __('t-hot') }}</span></a>
                </li>

                @can("GeneralSettings")
								<li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarSiteOptions" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSiteOptions">
                        <i class="bx bxs-cog"></i> <span data-key="t-SiteOptionsTab">{{ __('t-SiteOptionsTab') }}</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarSiteOptions">
                        <ul class="nav nav-sm flex-column">
													<li class="nav-item">
														<a href="{{route('SiteOptions', "Identity")}}" class="nav-link" data-key="t-SiteIdentity">{{ __('t-SiteIdentity') }}</a>
												</li>
													<li class="nav-item">
														<a href="{{route('SiteOptions', "Contacts")}}" class="nav-link" data-key="t-SiteContacts">{{ __('t-SiteContacts') }}</a>
												</li>
													<li class="nav-item">
														<a href="{{route('SiteOptions', "Scripts")}}" class="nav-link" data-key="t-SiteScripts">{{ __('t-SiteScripts') }}</a>
												</li>
										</ul>
										</div>
								</li>
								...
								<li class="nav-item">
									...
									<div class="collapse menu-dropdown" id="sidebarAccounts">
										<ul class="nav nav-sm flex-column">
											...
											@can("UsersRoles")
											<li class="nav-item">
													<a href="{{route('UserRoles')}}" class="nav-link" data-key="t-user-roles">{{ __('t-user-roles') }}</a>
											</li>
											@endcan
											<li class="nav-item">
													<a href="{{route('AdminUsers')}}" class="nav-link" data-key="t-dashboard-admins">{{ __('t-dashboard-admins') }}</a>
											</li>
										</ul>
									</div>
                </li>
                ...
                @can("SectorsManagement")
								<li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPostsSettings" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPostsSettings">
											<i class="bx bxs-wrench"></i> <span data-key="t-PostsSettingsTab">{{ __('t-PostsSettingsTab') }}</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarPostsSettings">
											<ul class="nav nav-sm flex-column">
												@can("DeveloperRole")
												<li class="nav-item">
													<a href="{{route('CreatePostType')}}" class="nav-link" data-key="t-PostTypes">{{ __('t-PostTypes') }}</a>
												</li>
												@endcan
												<li class="nav-item">
													<a href="{{route("CreateCategory")}}" class="nav-link" data-key="t-Categories">{{ __('t-Categories') }}</a>
												</li>
											</ul>
										</div>
								</li>
								...
								<li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarPostsPages" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPostsPages">
											<i class="bx bxs-wrench"></i> <span data-key="t-PostsPagesTab">{{ __('t-PostsPagesTab') }}</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarPostsPages">
											<ul class="nav nav-sm flex-column">
												@can("Posts")
												<li class="nav-item">
													<a href="{{route("CreatePost")}}" class="nav-link" data-key="t-Posts">{{ __('t-Posts') }}</a>
												</li>
												@endcan
												@can("Pages")
												<li class="nav-item">
													<a href="{{route("CreatePage")}}" class="nav-link" data-key="t-Pages">{{ __('t-Pages') }}</a>
												</li>
												@endcan
												@can("GeneralContent")
												<li class="nav-item">
													<a href="{{route("CreateSlider")}}" class="nav-link" data-key="t-Sliders">{{ __('t-Sliders') }}</a>
												</li>
												@endcan
											</ul>
										</div>
